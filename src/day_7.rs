...
impl Day7 {
    ...
    pub fn solve() -> Result<(), Box<dyn Error>> {
        ...
        for line in reader.lines() {
            let (hand, score) = Day7::parse_line(&line?);
            let value = Day7::calc_hand_value(&hand);
    ...
    fn calc_hand_value(hand: &str) -> u32 {
        ...
        counts.sort_unstable_by_key(|c| (u32::MAX - c.1, u32::MAX - Day7::get_card_value(c.0)));
        ...
        type_value  + Day7::get_card_value(hand.chars().nth(0).unwrap()) * 0x10000 
                    + Day7::get_card_value(hand.chars().nth(1).unwrap()) * 0x1000 
                    + Day7::get_card_value(hand.chars().nth(2).unwrap()) * 0x100
                    + Day7::get_card_value(hand.chars().nth(3).unwrap()) * 0x10 
                    + Day7::get_card_value(hand.chars().nth(4).unwrap())
    }
